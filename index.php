...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp ISRAELITE HIMS</h4></a>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="11" name="contact" class="form-control" placeholder="Your Phone *"  />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="maxl">
                                            <label class="radio inline"> 
                                                <input type="radio" name="designation" value="Student" checked>
                                                <span> Student </span> 
                                            </label>
                                            <label class="radio inline"> 
                                                <input type="radio" name="designation" value="Lecturer">
                                                <span>Lecturer </span> 
                                            </label>
                                        </div>
