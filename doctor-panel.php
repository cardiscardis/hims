...
if(isset($_GET['cancel']))
  ...
  {
    $query=mysqli_query($con,"update appointmenttb set userStatus='2', doctorStatus='2' where ID = '".$_GET['ID']."'");
    if($query)
    {
      echo "<script>alert('Your appointment successfully accepted!');</script>";
    }
  }
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> ISRAELITE HIMS</a>
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list" role="tab" data-toggle="list" aria-controls="home">Patient Messages</a>
                  ...
                  <?php 
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                     ...
                     <td>
                        ...
                        <?php if(($row['userStatus']==2) && ($row['doctorStatus']==2))  
                        { ?>
                        ...
                        <td>
	                        <a href="connect.php?patientEmail=<?php echo $row['email']?>&doctor=<?php echo $doctor?>&patientLastName=<?php echo $row['lname']?>&patientFirstName=<?php echo $row['fname']?>&who=doctor"
                              onClick="return confirm('Are you sure you want to send message ?')"
                              title="Send Message" tooltip-placement="top" tooltip="Connect">
                              <button class="btn btn-primary">Message Patient</button>
                          </a>
                        </td>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select * from connect where doctorname='$doctor';";
                    $result = mysqli_query($con,$query);
                    while ($row = mysqli_fetch_array($result)){
                  ...
                  ?>
                      <tr>
                        <td><?php echo $row['patientfirstname']; echo ' '; echo $row['patientlastname'];?></td>
