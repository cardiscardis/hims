...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into patreg(fname,lname,gender,email,contact,password,cpassword,designation) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword','$designation');";
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> ISRAELITES HIMS</a>
