...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> ISRAELITE HIMS</h2></br>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-mes" id="list-mes-list" role="tab" data-toggle="list" aria-controls="home">Doctor Messages</a>
                    ...
                    if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
                    {
                      echo "Cancelled by Doctor";
                        ...
                        { ?>
                         ...
                         <td>
	                        <a href="connect.php?patientEmail=<?php echo $email?>&doctor=<?php echo $row['doctor']?>&patientLastName=<?php echo $lname?>&patientFirstName=<?php echo $fname?>&who=patient"
                              onClick="return confirm('Are you sure you want to send message ?')"
                              title="Send Message" tooltip-placement="top" tooltip="Connect">
                              <button class="btn btn-primary">Message Doctor</button>
                          </a>
                        </td>
                      </tr>
                    <?php } ?>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Bill Generated Successfully');" name ="generate_bill" class = "btn btn-success" value="Generate"/>
                              </a>
                              </td>
                              </form>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select * from connect where patientemail='$email';";
                    $result = mysqli_query($con,$query);
                    while ($row = mysqli_fetch_array($result)){
